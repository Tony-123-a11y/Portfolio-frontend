...
const Home = () => {
  ...
  return (
    <div id='home' className='home bg-fixed  bg-cover relative flex items-center justify-center h-[calc(92vh-74px)] '>
...
transition={{
  ...
  className="wave3 fill-white opacity-[.4] ">
    ...
    <h4 className='font-medium text-4xl text-gray-800 my-5 max-lg:text-3xl max-sm:text-2xl'>Front-End Developer</h4>
    ...
    <div className="flex justify-center  gap-4 mt-8 max-sm:justify-center">
      <button className='text-base flex items-center justify-center gap-2 text-black cursor-pointer px-7 py-3 bg-white capitalize font-medium tracking-wide rounded-md hover:bg-white/80  transition duration-200 max-sm:text-sm'><MdDownload fontSize={20}/> <span>resume</span> </button>
